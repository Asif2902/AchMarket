...
export const MARKET_V2_ABI = [
  ...
  "function resolvedPoolWei() view returns (uint256)",
  "function marketPoolWei() view returns (uint256)",
  "function feePoolWei() view returns (uint256)",
  "function payoutPerWinningShareWad() view returns (uint256)",
  "function payoutPerInvalidShareWad() view returns (uint256)",
  "function totalWinningSharesAtResolution() view returns (uint256)",
  "function totalClaimSharesAtResolution() view returns (uint256)",
  "function remainingClaimSharesWad() view returns (uint256)",
  "function totalClaimedWei() view returns (uint256)",
  "function mmSpreadBps() view returns (uint256)",
  "function lastTradePriceWad(uint256) view returns (uint256)",
  "function sharesOf(address, uint256) view returns (uint256)",
  ...
  "function previewMMBuyFromState(uint256 outcomeIdx, uint256 soldSharesWad, uint256 sharesWad) view returns (uint256)",
  "function previewMMSellFromState(uint256 outcomeIdx, uint256 soldSharesWad, uint256 reserveWei, uint256 sharesWad) view returns (uint256)",
  "function getMMOutcomeState(uint256 outcomeIdx) view returns (uint256 initialSharesWad, uint256 availableSharesWad, uint256 soldSharesWad, uint256 reserveWei, uint256 bidPriceWad, uint256 askPriceWad)",
  "function getUserInfo(address user) view returns (uint256[] _shares, bool _redeemed, bool _canRedeem)",
  "function redeem()",
  "function triggerExpiry()",
  "function setAuthorizedOperator(address operator, bool allowed)",
  "function setResolutionManager(address _resolutionManager)",
  "function setMMSpreadBps(uint256 _mmSpreadBps)",
...
export const MARKET_ROUTER_ABI = [
  ...
  "function buy(address market, uint256 outcome, uint256 sharesWad, uint256 minSharesOutWad, uint256 maxCostWei, uint256 maxHops, uint256 deadline) payable returns (tuple(uint256 requestedSharesWad, uint256 filledSharesWad, uint256 orderBookSharesWad, uint256 mmSharesWad, uint256 costWei, uint256 proceedsWei, uint256 feeWei, bool usedOrderBook, bool usedMM, bool isPartial))",
  "function sell(address market, uint256 outcome, uint256 sharesWad, uint256 minSharesOutWad, uint256 minProceedsWei, uint256 maxHops, uint256 deadline) returns (tuple(uint256 requestedSharesWad, uint256 filledSharesWad, uint256 orderBookSharesWad, uint256 mmSharesWad, uint256 costWei, uint256 proceedsWei, uint256 feeWei, bool usedOrderBook, bool usedMM, bool isPartial))",
  ...
  "function previewBuyForAmount(address market, uint256 outcome, uint256 maxCostWei, uint256 maxHops) view returns (tuple(uint256 requestedSharesWad, uint256 filledSharesWad, uint256 orderBookSharesWad, uint256 mmSharesWad, uint256 costWei, uint256 proceedsWei, uint256 feeWei, bool usedOrderBook, bool usedMM, bool isPartial))",
  "function previewSellForAmount(address market, uint256 outcome, uint256 targetProceedsWei, uint256 maxSharesWad, uint256 maxHops) view returns (tuple(uint256 requestedSharesWad, uint256 filledSharesWad, uint256 orderBookSharesWad, uint256 mmSharesWad, uint256 costWei, uint256 proceedsWei, uint256 feeWei, bool usedOrderBook, bool usedMM, bool isPartial))",
  ...
  "function setFees(uint256 _orderBookTakerFeeBps, uint256 _mmTakerFeeBps)",
  "function setExecutionConfig(uint256 _chunkSizeWad, uint256 _maxTradeSharesWad, uint256 _defaultMaxHops)",
  "event HybridTrade(address indexed trader, address indexed market, uint256 indexed outcome, uint8 side, uint256 requestedSharesWad, uint256 filledSharesWad, uint256 orderBookSharesWad, uint256 mmSharesWad, uint256 costWei, uint256 proceedsWei, uint256 feeWei)",
  ...
  "event MmQuoteUsed(address indexed market, uint256 indexed outcome, uint8 side, uint256 sharesWad, uint256 amountWei)",
] as const;
...
export const ORDER_BOOK_ABI = [
  ...
  "function maxMatchesPerOrder() view returns (uint256)",
  ...
  "function getUserOrderIds(address user, uint256 offset, uint256 limit) view returns (uint256[])",
  "function getUserOrders(address user, address market, bool openOnly, uint256 offset, uint256 limit) view returns (tuple(uint256 id, address market, uint256 outcome, address owner, uint8 side, uint256 priceWad, uint256 remainingSharesWad, uint256 escrowWei, uint256 expiry, bool active, uint256 originalSharesWad, uint8 status)[])",
  "function setAllowedMarket(address market, bool allowed)",
  "function setPaused(bool _paused)",
  "function setMakerFeeBps(uint256 _makerFeeBps)",
  "function setTakerFeeBps(uint256 _takerFeeBps)",
  "function setMaxMatchesPerOrder(uint256 _maxMatchesPerOrder)",
...
export const HYBRID_FACTORY_ABI = [
  ...
  "function requiredSeed(uint256 outcomeCount, int256 bWad) pure returns (uint256)",
  "function minBWad() view returns (int256)",
  "function maxBWad() view returns (int256)",
  "function minDuration() view returns (uint256)",
  "function maxDuration() view returns (uint256)",
  "function getMarketCount() view returns (uint256)",
  "function getMarkets(uint256 offset, uint256 limit) view returns (address[])",
  "function createMarket(string _title, string _description, string _category, string _imageUri, string[] _outcomeLabels, uint8 _mode, int256 _bWad, uint256 _durationSeconds, string _resolutionSource, uint256 _resolutionTime, string _fallbackResolutionSource, string _invalidCondition) returns (address market)",
  ...
  "event MarketCreated(address indexed market, uint256 indexed marketId, address indexed creator, string title, string category, uint256 outcomeCount, uint256 deadline, uint256 resolutionTime, address resolutionManager, uint8 mode, int256 bWad, uint256 seedWei)",
  "event CreationPausedUpdated(bool paused)",
] as const;

export const HYBRID_LENS_ABI = [
  "function getMarketSummaries(uint256 offset, uint256 limit) view returns (tuple(address market, uint256 marketId, string title, string category, string imageUri, string[] outcomeLabels, int256[] impliedProbabilitiesWad, uint8 stage, uint256 winningOutcome, uint256 marketDeadline, uint256 resolutionTime, uint256 totalVolumeWei, uint256 participants, uint8 mode, int256 bWad)[])",
  "function getMarketDetail(address market) view returns (tuple(address market, string title, string description, string category, string imageUri, string proofUri, string[] outcomeLabels, int256[] totalSharesWad, int256[] impliedProbabilitiesWad, uint8 stage, uint256 winningOutcome, uint256 createdAt, uint256 marketDeadline, uint256 resolutionTime, int256 bWad, uint256 totalVolumeWei, uint256 participants, uint8 mode, uint256 resolvedPoolWei, string cancelReason, string cancelProofUri, string resolutionSource, string fallbackResolutionSource, string invalidCondition, address resolutionManager))",
