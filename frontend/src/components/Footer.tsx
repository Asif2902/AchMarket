  ...
  return (
    <>
      ...
      <div className="md:hidden border-t border-white/[0.06]">
        <button
          onClick={() => setOpen(o => !o)}
          className="w-full flex items-center justify-between px-4 py-2.5 text-xs text-dark-400 hover:text-white transition-colors"
          aria-expanded={open}
        ...
        {open && (
          <div id="mobile-footer-links" className="px-4 pb-4 space-y-3">
            <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-dark-400">
              ...
              <a href="https://x.com/AchPredict" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-white transition-colors">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                X
              </a>
            </div>
            <div className="flex items-center gap-2 px-2 py-1 rounded-lg bg-dark-900/40 border border-white/[0.06] w-fit">
