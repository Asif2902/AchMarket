  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center animate-fade-in-up">
      <div className="w-16 h-16 rounded-2xl bg-dark-800/60 border border-white/[0.08] flex items-center justify-center mb-5 relative">
        ...
        <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-dark-900 border border-white/[0.08] flex items-center justify-center" aria-hidden="true">
          <svg className="w-3 h-3 text-dark-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} focusable="false">
