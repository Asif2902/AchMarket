        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <aside className="hidden lg:block w-56 shrink-0">
            <div className="card p-3 sticky top-24">
              <div className="px-2 pb-2 mb-2 border-b border-[var(--bg-border)]">
                <p className="text-2xs font-semibold uppercase tracking-[0.14em] text-white/45">Categories</p>
              </div>
              <div className="space-y-1.5">
                {categoryCounts.map(({ category, count }) => (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-xs transition-all duration-150 ${
                      categoryFilter === category
                        ? 'bg-primary-500/15 text-primary-300 border border-primary-500/30'
                        : 'text-white/65 border border-transparent hover:text-white hover:bg-white/[0.04]'
                    }`}
                  >
